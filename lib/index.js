    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield openai.createChatCompletion({
            ...
            messages: [
                {
                    role: 'system',
                    content: 'You are a helpful code reviewer. Provide a concise summary of the overall changes in this pull request.',
                },
                {
                    role: 'user',
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield openai.createChatCompletion({
            ...
            messages: [
                {
                    role: 'system',
                    content: "You are a helpful code reviewer. Provide constructive feedback on the code changes. Focus your feedback on the changed parts of the code (lines starting with '+' or '-'), but use the surrounding context to inform your analysis. At the end of your feedback, add a new line with just 'CRITICAL_FEEDBACK:' followed by 'true' if you have substantial or critical feedback, or 'false' if your feedback is minor or just positive.",
                },
                {
                    role: 'user',
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const prSummary = yield generatePRSummary(openai, changedFiles);
            yield updatePRDescription(octokit, github.context, prSummary);
            ...
            yield addPRComment(octokit, github.context, fileAnalyses);
        }
        catch (error) {
